...
SyncPlay `onError` frames render through `describeSyncPlayError` (`src/syncplay/syncplayErrors.ts`): code catalog first, server `message` second, generic fallback last.
